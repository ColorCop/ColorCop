...
v5.4.6 - 01/17/12 - added keyboard shortcut for increasing multi-pixel averaging
		  - increased pixel finder in magnified view when using multi-
                    pixel averaging. Try plus / minus on the numeric keypad.
